...
<header id="js-header" class="u-header u-header--sticky-top u-header--change-appearance"
    ...
    <div class="u-header__section u-header__section--dark g-bg-black-opacity-0_7 g-transition-0_3 g-py-10"
        ...
        data-header-fix-moment-classes="g-py-5">
        <nav class="navbar navbar-toggleable-md">
            <div class="container">
                ...
                <!-- Logo -->
                <a href="/sunoco" class="navbar-brand">
                <img src="../assets/img/sunoco-logo.png" alt="Image Description">
                </a>
                <!-- End Logo -->
                <!-- Navigation -->
                <div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
                    <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                        <li class="nav-item active">
                            <a href="/sunoco/products" class="nav-link g-px-0">Proizvodi</a>
                        </li>
                    </ul>
                </div>
                <!-- End Navigation -->
